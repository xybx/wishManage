...
<script setup lang="ts">
 ...
 const getQueryList = () => {
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'adduserid', label: '举报人ID',sortable:true},
                    {prop: 'addnickname', label: '举报人昵称',sortable:true},
                    {prop: 'touserid', label: '被举报人ID',sortable:true},
                    {prop: 'tonickname', label: '被举报人昵称',sortable:true},

                    {prop: 'scontent', label: '举报内容',sortable:true},

                    {prop: 'addtime', label: '举报时间',sortable:true},

                    {prop: 'ishandle', label: '待处理',sortable:true},

                    {prop: 'operuser', label: '处理人',sortable:true},

                   {prop: 'opertime', label: '处理时间',sortable:true},
