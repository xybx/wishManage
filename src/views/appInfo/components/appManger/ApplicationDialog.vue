    ...
    >
      ...
      >
        ...
        <template v-if="item.type == 'text'">
          ...
          <div v-if="item.name == 'actionurl'" style="color: red">
            格式：http://ip:端口/请求前缀/在线用户接口
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;不要加参数
          </div>
        </template>
        <!-- 文本域 -->
...
import { selectById, add, update } from "/@/api/appinfo/ApplicationDialogApi";
import { isUrl } from "/@/utils/validate";
// import {UploadFile, selectListByUuid, deleteFile, delByUuids, baseUrl
// } from "/@/types/appinfo/ApplicationTypes";
...
const rules = reactive<FormRules>({
  ...
  actionurl: [
    ...
    { trigger: "blur", validator: validateHTTP },
  ],
