...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'userid', label: '兑换人ID',sortable:true},

                    {prop: 'nickname', label: '兑换人昵称',sortable:true},

                    {prop: 'addtime', label: '兑换时间',sortable:true},

                    {prop: 'price', label: '兑换价格',sortable:true},

                    {prop: 'status', label: '处理状态',sortable:true },
                    {prop: 'operuser', label: '操作人',sortable:true},

                    {prop: 'opertime', label: '操作时间',sortable:true},
