...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    ...
                    {prop: 'bgtime', label: '活动开始时间',sortable:true},

                    {prop: 'edtime', label: '活动结束时间',sortable:true},

                    {prop: 'introduction', label: '活动简介',sortable:true},

                    {prop: 'joinpeople', label: '参加对象',sortable:true},

                    {prop: 'rewardnum', label: '抽奖名额',sortable:true},
                    
                    {prop: 'rewardrate', label: '中奖概率',sortable:true},
                    
                    {prop: 'score', label: '抽奖心愿力',sortable:true},

                    {prop: 'region', label: '活动区域',sortable:true},

                    {prop: 'award', label: '奖品说明',sortable:true},

                    {prop: 'payment', label: '领取方式',sortable:true},

                    {prop: 'awardtips', label: '获奖提示',sortable:true},

                    {prop: 'updatetime', label: '修改时间',sortable:true},

                    {prop: 'updatebyuser', label: '修改人',sortable:true},

                    {prop: 'showbgtime', label: '活动开始展示时间',sortable:true},
                    {prop: 'hideedtimg', label: '活动结束展示时间',sortable:true},

                    {prop: 'adduser', label: '添加人',sortable:true},
