...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    ...
                    {prop: 'sname', label: '简称',sortable:true},

                    {prop: 'stitle', label: '标题',sortable:true},

                    {prop: 'snumber', label: '活动编号',sortable:true},

                    {prop: 'sharetype', label: '互助类型',sortable:true},

                    {prop: 'paywishpower', label: '消费心愿力',sortable:true},

                    {prop: 'joinnumber', label: '参加人数',sortable:true},

                    {prop: 'joincity', label: '参加城市',sortable:true},

                    {prop: 'addtime', label: '添加时间',sortable:true},

                    {prop: 'updatetime', label: '修改时间',sortable:true},

                    {prop: 'endtime', label: '截止时间',sortable:true},
