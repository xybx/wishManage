...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'promoterid', label: '推荐人ID',sortable:true},
                    {prop: 'promotername', label: '推荐人',sortable:true},
                    {prop: 'promoteeid', label: '被推荐人ID',sortable:true},
                    {prop: 'promoteename', label: '被推荐人',sortable:true},
                    {prop: 'createtime', label: '注册时间',sortable:true},
                    {prop: 'iscomplete', label: '是否完成',sortable:true,list:iscompleteSelectData.value },
                    {prop: 'remark', label: '说明',sortable:true},
                    {prop: 'updatetime', label: '完成时间',sortable:true},
