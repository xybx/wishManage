<template>
  ...
  <script setup lang="ts">
    ...
    import { getWishDataListApi, del, putMultiDel
    ...
    const getTableList = async () => {
        debugger;
      let params: any = {wishid:wishid,pageNum: pageNum.value, pageSize: pageSize.value,sortType:sortType.value,sortColumn:sortColumn.value };
      ...
      let res: any = await getWishDataListApi(params);
      if (res.code == 200) {
