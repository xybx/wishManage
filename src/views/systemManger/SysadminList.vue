...
import editDialog from "./components/SysadminDialog.vue";
...
import type {
  ...
  JsonProps,
  DialogProps,
} from "/@/types/sysManger/SysadminTypes";
import {
  getDataListApi,
  del,
  putMultiDel,
} from "/@/api/sysManger/SysadminApi.ts";
...
//重置密码
const resetPassw = async (pid1: number) => {
  pid.value = pid1;
